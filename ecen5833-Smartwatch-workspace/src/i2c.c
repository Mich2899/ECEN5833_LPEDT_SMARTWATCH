                               ...
                               uint8_t ReadLen)
{
  ...
  TransferSeq.addr    = (TMP117_I2CADDR << 1);
...
void setShutdownModeTMP117()
{
  ...
  uint8_t ret_status = I2CTransferInitWrapper(SD_DataBuffer, I2C_FLAG_WRITE,
...
void setOneShotModeTMP117()
{
  ...
  uint8_t ret_status = I2CTransferInitWrapper(&OS_DataBuffer, I2C_FLAG_WRITE,
...
void getTemperatureTMP117()
{
  ...
  uint8_t ret_status = I2CTransferInitWrapper(&TP_DataBuffer, I2C_FLAG_WRITE_READ,
                                              1, 2);
  if(ret_status)
      return;
}
